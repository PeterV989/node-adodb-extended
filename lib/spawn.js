...
const exitMessages = {
  ...
  4: 'Internal JavaScript Evaluation Failure (Bad SQL/Query)',
  5: 'Fatal Error',
  6: 'Non-function Internal Exception Handler (Connection/Driver Error)', 
  7: 'Internal Exception Handler Run-Time Failure',
  9: 'Invalid Argument (Authentication/Access Error)',
  10: 'Internal JavaScript Run-Time Failure (Database Error)',
